...
export class AccountActivationTokenMapper {
  static toDomain(orm: AccountActivationTokenOrmEntity): AccountActivationTokenDomainEntity {
  ...
  static toOrm(domain: AccountActivationTokenDomainEntity): AccountActivationTokenOrmEntity {
