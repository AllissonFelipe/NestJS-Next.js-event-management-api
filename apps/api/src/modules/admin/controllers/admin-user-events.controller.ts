import { Controller, Delete, Get, HttpCode, HttpStatus, Inject, Param, Query, Request } from '@nestjs/common';
...
export class AdminUserEventsController {
  ...
  async findAllEventsOfUserByPersonId(
    ...
    return await this.adminFindEventsUseCase.allEventsOfUserByPersonId(req.user.sub, userPersonId, filters);
  }
  ...
  async findEventByUserIdAndEventId(
    ...
    return await this.adminFindEventsUseCase.byUserIdAndEventId(req.user.sub, userPersonId, eventId);
  }
