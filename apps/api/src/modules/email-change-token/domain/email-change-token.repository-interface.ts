...
export interface EmailChangeTokenRepositoryInterface {
  save(token: EmailChangeTokenDomainEntity, manager?: EntityManager): Promise<EmailChangeTokenDomainEntity>;
  markAllTokensAsUsed(personId: string, manager?: EntityManager): Promise<void>;
  findByHashToken(hashToken: string, manager?: EntityManager): Promise<EmailChangeTokenDomainEntity | null>;
}
