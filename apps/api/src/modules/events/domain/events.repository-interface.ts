...
export interface EventsRepositoryInterface {
    ...
    findAllMyEventsWithFiltersByOwnerId(ownerId: string, filters: FindEventFilters, manager?: EntityManager): Promise<PaginatedResult<EventsDomainEntity>>;
    saveEvent(event: EventsDomainEntity, manager?: EntityManager): Promise<EventsDomainEntity>;
    findAllPublicEventsWithFilters(filters: FindEventFilters, manager?: EntityManager): Promise<PaginatedResult<EventsDomainEntity>>;
