...
export class NewTableEventsImages1770232939961 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX "IDX_EVENTS_IMAGES_EVENT_ID" ON "events_images" ("event_id") `);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "events_images" DROP CONSTRAINT "FK_fbe0e902db77f8f6490f365d867"`);
