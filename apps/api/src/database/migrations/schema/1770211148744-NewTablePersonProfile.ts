...
export class NewTablePersonProfile1770211148744 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "person" ADD "person_profile_id" uuid NOT NULL`);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "person" DROP CONSTRAINT "FK_528df16241129dedc429b9e805c"`);
    await queryRunner.query(`ALTER TABLE "person" DROP CONSTRAINT "UQ_528df16241129dedc429b9e805c"`);
    await queryRunner.query(`ALTER TABLE "person" DROP COLUMN "person_profile_id"`);
