...
export class FixTablePerson1770128434758 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "person" ADD CONSTRAINT "FK_3174485ebeabc40bb5681e1894b" FOREIGN KEY ("person_role_id") REFERENCES "person_role"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "person" DROP CONSTRAINT "FK_3174485ebeabc40bb5681e1894b"`,
    );
