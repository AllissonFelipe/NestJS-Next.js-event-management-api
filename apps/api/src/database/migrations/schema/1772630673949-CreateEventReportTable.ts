...
export class CreateEventReportTable1772630673949 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TYPE "public"."event_report_status_enum" AS ENUM('OPEN', 'REVIEWED', 'RESOLVED')`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "event_reports" DROP CONSTRAINT "FK_8b3ac0971b2cc1b54fcc7c31cb1"`);
    await queryRunner.query(`ALTER TABLE "event_reports" DROP CONSTRAINT "FK_48c46235d0db6bdba80fda2e947"`);
