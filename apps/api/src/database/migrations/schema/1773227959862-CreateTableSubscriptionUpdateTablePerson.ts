...
export class CreateTableSubscriptionUpdateTablePerson1773227959862 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "subscription_plans" ALTER COLUMN "is_active" SET DEFAULT true`);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "subscription_plans" ALTER COLUMN "is_active" DROP DEFAULT`);
